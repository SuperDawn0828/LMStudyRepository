...
class LMCustomView: LMPopupView, UITextFieldDelegate {
    ...
    convenience init(title: String?, detail: String?, actions: [LMPopupAction]) {
        self.init(title: title, detail: detail, placeholder: nil, actions: actions, inputhandler: nil)
    }
    
    convenience init(title: String?, detail: String?, placeholder: String?, actions: [LMPopupAction], inputhandler: InputHandler?) {
